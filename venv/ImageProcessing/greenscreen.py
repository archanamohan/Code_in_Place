...
def main():
    ...
    """
    original_stop = SimpleImage('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\stop.png')
    #C:\Users\Archana\Desktop\Codes\NewBeginings\Python\images\stop.png
    #images/stop.png
    original_stop.show()

    original_leaves = SimpleImage('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\leaves.png')
    original_leaves.show()

    stop_leaves_replaced = redscreen('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\stop.png', 'C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\leaves.png')
