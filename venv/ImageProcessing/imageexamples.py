...
from ImageProcessing.simpleimage import SimpleImage
...
def main():
    ...
    """
    flower = SimpleImage('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\flower.png')
    flower.show()

    darker(flower)
    flower.show()

    red_flower = red_channel('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\flower.png')
    red_flower.show()
