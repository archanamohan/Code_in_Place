...
def main():
    ...
    """
    original = SimpleImage('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\burrito.jpg')
    original.show()

    mirrored = mirror_image('C:\\Users\\Archana\\Desktop\\Codes\\NewBeginings\\Python\\images\\burrito.jpg')
    mirrored.show()
